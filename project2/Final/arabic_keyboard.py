...
def play_audio():
    audio_folder = "C:\\Users\\Dell\\Desktop\\arabic.wav"
    pygame.mixer.init()
...
arabic_config.add_shortcut_action('Alt+t', lambda: keyboard.write('طائرة'), configType.HotKey)
arabic_config.add_shortcut_action('Alt+g', lambda: keyboard.write('سيارة'), configType.HotKey)
arabic_config.add_shortcut_action('Alt+b', lambda: keyboard.write('طائر النورس'), configType.HotKey)
...
#arabic_config.add_shortcut_action('F1',  lambda: keyboard.press_and_release('alt+shift'), configType.HotKey)
